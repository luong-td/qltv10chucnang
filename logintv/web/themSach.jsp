...
<!--                        <li>User name</li>-->
        ...
        <form action="ThemSachServlet" method="post">
            ...
            <label>Tác giả</label>
            <input type="text" name="tacgia"  required><br>
            <label>Số lượng</label>
            <input type="text" name="slg"  required><br>
            <input type="submit" value="Them moi">
        </form>
            <c:if test="${checkThem == '1'}"><script>alert("Bạn đã them sach thành công")</script></c:if>
            <c:if test="${checkThem == '0'}"><script>alert("Ma sach da co")</script></c:if>
