...
<!--                        <li>User name</li>-->
        ...
        <h1>Bảng Nhan Vien</h1>
        
        
        <div class="qlnhanvien">
        <form action="NhanVienServlet" method="post">
        <input style="width: 600px; opacity: 0" type="hidden=">
        ...
        <input class="sub" type="submit" name="action" value="Xem">
        ...
        <c:if test="${checkXoa == '1'}"><script>alert("Bạn da xoa thanh cong")</script></c:if>
            <table cellpadding="3" border=1 class="tbsach">
                <thead>
                <tr valign="bottom">
                    <td align="left" style="width: 50px"><b>Click</b></td>
                    <td align="left"><b>mã </b></td>
                    <td align="left"><b>tên </b></td>
                    <td align="left"><b>so dien thoai</b></td>
                    
                </tr>
                </thead>
                <c:forEach var="i" items ="${listNhanVien}">
